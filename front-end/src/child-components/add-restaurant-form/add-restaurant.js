  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className=" m-3 ">
      ...
      <div className="form-group">
        ...
        <input type="text" className="form-control" {...register("restaurantName")}  type="name" placeholder="enter restaurant name" />
      </div>
      ...
      <div className="form-group ">
        ...
        <input type="text" className="form-control" {...register("cityName")}  placeholder="enter city name" />
          ...
          <div className="form-group col">
            ...
            <input type="number" className="form-control" {...register("zipCode")}  placeholder="enter zip-code" />
          </div>

          <span className="select-holder form-group col">
          <select className="state-selection select form-group"{...register("state")}
            onMouseDown={stateDropdown.onMouseDown}    onChange={stateDropdown.onChange} 
          >
                <option>Choose State</option>
                {stateNames.map(state => <option key={state.abbreviation} value={state.abbreviation}>{`${state.abbreviation}, ${state.name}`}</option>)}
          </select>
          </span>
      </div>
         ...
         <div className="form-group">
          ...
          <input type="number" className="form-control" {...register("number")}  placeholder="enter phone-number" />
        </div>

        <div className="form-group ">
          <label >Restaurant type</label>
          <input type="text" className="form-control" {...register("type")}  placeholder="turkish, mexican, indian etc..." />
        </div>
        ...
        <div className="form-group ">
          ...
          <textarea placeholder="Describe  what the restaurant offers. No more the 120 characters"className="form-control" {...register("description")} maxLength={120}>
